<template>
  <v-container>
    ...
    <v-table class="ma-2">
      <thead class="bg-grey">
        <tr>
          <th class="text-left" v-for="item in tableHeaders" :key="item" v-text="item" />
    ...
    <!-- Diálogo de inserção e edição de tarefa -->
...
<script setup lang="ts">
  ...
  import { useTaskStore } from '../stores/task_manager';
  import { useMovement } from '../stores/movement';
